...
namespace PreconditionsSample
{
    public class AListener : Automa
    {
        ...
        [NextState(state = STATE_STOP)]
        protected void PreConditionEventValueTest(int value)
        {
            Print("Executing state 'PreConditionEventValueTest'. Value = " + 3);
            Sleep(1000);
        }
        ...
        [NextState(state = STATE_STOP)]
        protected void PreConditionEventValuesTest(int number, String text, int secondNumber)
        {
            Print("Executing state 'PreConditionEventValuesTest'. number = " + number + ", text = " + text + ", secondNumber = " + secondNumber);
            Sleep(1000);
        }
